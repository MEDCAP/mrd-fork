...
classdef ImageHeaderSerializer < yardl.binary.RecordSerializer
  methods
    function self = ImageHeaderSerializer()
      ...
      field_serializers{19} = yardl.binary.EnumSerializer('mrd.ImageType', @mrd.ImageType, yardl.binary.Int32Serializer);
      field_serializers{20} = yardl.binary.OptionalSerializer(yardl.binary.EnumSerializer('mrd.ImageQuantitativeType', @mrd.ImageQuantitativeType, yardl.binary.Uint64Serializer));
      field_serializers{21} = yardl.binary.OptionalSerializer(yardl.binary.Uint32Serializer);
      field_serializers{22} = yardl.binary.OptionalSerializer(yardl.binary.Uint32Serializer);
      field_serializers{23} = yardl.binary.VectorSerializer(yardl.binary.Int32Serializer);
      field_serializers{24} = yardl.binary.VectorSerializer(yardl.binary.Float32Serializer);
