...
classdef AcquisitionHeaderSerializer < yardl.binary.RecordSerializer
  methods
    ...
    function write(self, outstream, value)
      ...
      self.write_(outstream, value.flags, value.idx, value.measurement_uid, value.scan_counter, value.acquisition_time_stamp_ns, value.physiology_time_stamp_ns, value.channel_order, value.discard_pre, value.discard_post, value.num_echoes, value.center_sample, value.encoding_space_ref, value.sample_time_ns, value.position, value.read_dir, value.phase_dir, value.slice_dir, value.patient_table_position, value.user_int, value.user_float);
    end

    function value = read(self, instream)
      fields = self.read_(instream);
      value = mrd.AcquisitionHeader(flags=fields{1}, idx=fields{2}, measurement_uid=fields{3}, scan_counter=fields{4}, acquisition_time_stamp_ns=fields{5}, physiology_time_stamp_ns=fields{6}, channel_order=fields{7}, discard_pre=fields{8}, discard_post=fields{9}, num_echoes=fields{10}, center_sample=fields{11}, encoding_space_ref=fields{12}, sample_time_ns=fields{13}, position=fields{14}, read_dir=fields{15}, phase_dir=fields{16}, slice_dir=fields{17}, patient_table_position=fields{18}, user_int=fields{19}, user_float=fields{20});
    end
  end
end
